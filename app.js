...
async function checkFlagAndSendMessage() {
  try {
    ...
    for (const entry of data) {
      ...
      let introduction = "These are the responses to a psychological test assessment (ADHD). Please review and give your view on the following answers LIKE A PSYCHOLOGIST ALSO TELL THE PROBABILITY % OF IT also present your data inreport format keep it under 100 words:";
