...
async function checkFlagAndSendMessage() {
  try {
    ...
    for (const entry of data) {
      ...
      let promptForDiagnosis = "Based on the above observations, please provide a concise diagnostic impression. Include a comment on the probable feelings or psychological states of the individual along with an estimated probability(in numeric percentage) of this diagnosis. Ensure this is formatted in an easy-to-understand manner for someone without a medical background. Also don't put any unctuation in response";
