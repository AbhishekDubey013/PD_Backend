...
async function checkFlagAndSendMessage() {
  try {
    ...
    for (const entry of data) {
      ...
      let introduction = "These are the responses to a psychological test assessment of Please review and give your view on the following answers LIKE A PSYCHOLOGIST ALSO TELL THE PROBABILITY % OF IT also present your data in report format";
